...
export default function DashboardScreen() {
	...
	const {
		tabunganList,
		isLoading: tabunganLoading,
		refetch: refetchTabungan,
	} = useTabungan();
	...
	if (!isAuthenticated) {
		Logger.info(
			"Dashboard",
			"User is not authenticated, redirecting to onboarding"
		);
	...
	const getAnnouncementIcon = (title: string) => {
		...
		if (
			lowerTitle.includes("pembiayaan") ||
